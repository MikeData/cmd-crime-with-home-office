...
CREATE (node:`_generic_hierarchy_node_offence` { code:'offence',label:'Offence' });
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'violence-against-the-person',label:'Violence against the person' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'drug-offences',label:'Drug offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'criminal-damage-and-arson',label:'Criminal damage and arson' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'fraud-offences',label:'Fraud offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'sexual-offences',label:'Sexual offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'public-order-offences',label:'Public order offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'possession-of-weapons-offences',label:'Possession of weapons offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'theft-offences',label:'Theft offences' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'theft-offences' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'aggravated-burglary-business-and-community',label:'Non-domestic burglary' })-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_offence` { code:'aggravated-burglary-business-and-community' })
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'miscellaneous-crimes-against-society',label:'Miscellaneous crimes against society' })-[:hasParent]->(parent);
...
MATCH (parent:`_generic_hierarchy_node_offence` { code:'offence' })
WITH parent CREATE (node:`_generic_hierarchy_node_offence` { code:'robbery',label:'Robbery' })-[:hasParent]->(parent);
